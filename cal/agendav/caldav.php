...
$config['caldav_principal_url'] = 'http://davical-tantpi.ddns.net/caldav.php/%u/';
...
$config['caldav_calendar_url'] = 'http://davical-tantpi.ddns.net/caldav.php/%s/';
 ...
 */
$config['public_caldav_url'] = 'http://davical-tantpi.ddns.net/caldav.php/%s/';
