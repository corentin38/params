...
|
*/
$config['base_url']	= 'http://agendav-tantpi.ddns.net/';
...
|
*/
$config['log_path'] = '/home/pi/cal/agendav/log/';
...
|
*/
$config['site_title'] = 'AgenDAV test session for J<3';
